/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 68fd6b455d2edc220d550380a044cc84)
...
interface __BaseEnv_Env {
	...
	EMAIL_FROM: "Clubhouse Scheduler <no-reply@staging.example.com>" | "Clubhouse Scheduler <no-reply@example.com>";
...
declare namespace Cloudflare {
	interface StagingEnv {
		...
		EMAIL_FROM: "Clubhouse Scheduler <no-reply@staging.example.com>";
		DEFAULT_TIMEZONE: "America/Denver";
		DEFAULT_HORIZON_DAYS: "90";
		DEV_AUTH: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_BASE_URL" | "GOOGLE_CLIENT_ID" | "BOOTSTRAP_ADMIN_EMAILS" | "EMAIL_FROM" | "DEFAULT_TIMEZONE" | "DEFAULT_HORIZON_DAYS" | "DEV_AUTH" | "EMAIL_PROVIDER">> {}
}
